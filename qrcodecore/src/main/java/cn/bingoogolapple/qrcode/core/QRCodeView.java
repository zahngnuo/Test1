...
public abstract class QRCodeView extends FrameLayout implements Camera.PreviewCallback, ProcessDataTask.Delegate {
    ...
    protected Delegate mDelegate;//代表
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        int zBarWidth = BGAQRCodeUtil.dp2px(context, 247);
        DisplayMetrics dm = getResources().getDisplayMetrics();
        if (dm.widthPixels != 0) {
            zBarWidth = dm.widthPixels - 60 - BGAQRCodeUtil.dp2px(context, 92);
        }
        mScanBoxView.initCustomAttrs(context, attrs, zBarWidth);
