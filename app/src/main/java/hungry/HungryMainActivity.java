...
import hungry.adapter.LeftMenuAdapter;
import hungry.adapter.RightDishAdapter;
import hungry.bean.Dish;
import hungry.bean.DishMenu;
import hungry.bean.ShopCart;
import hungry.weight.FakeAddImageView;
import hungry.weight.PointFTypeEvaluator;
 ...
 * date:${Date}
 */
public class HungryMainActivity extends Activity implements LeftMenuAdapter.onItemSelectedListener, ShopCartImp {
