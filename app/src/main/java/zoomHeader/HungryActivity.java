...
public class HungryActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_hungry_act);
    ...
    class Adapter extends PagerAdapter {
        public Adapter() {
            views = new ArrayList<>();
            views.add((RelativeLayout) View.inflate(HungryActivity.this, R.layout.item_img, null));
            views.get(0).findViewById(R.id.btn_buy).setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v) {
                    Toast.makeText(HungryActivity.this, "buy", Toast.LENGTH_SHORT).show();
                }
            });
            views.add((RelativeLayout) View.inflate(HungryActivity.this, R.layout.item_img, null));
