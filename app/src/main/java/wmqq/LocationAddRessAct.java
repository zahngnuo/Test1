 ...
 */
public class LocationAddRessAct extends Address implements RadioGroup.OnCheckedChangeListener,
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.bt_location) {
            if (btLocation.getText().equals("startLocation")) {
                setViewEnable(false);
                btLocation.setText("stopLocation");
                tvResult.setText("正在定位...");
                startLocation();
            } else {
                setViewEnable(true);
                btLocation.setText("startLocation");
                stopLocation();
