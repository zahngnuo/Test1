...
import shopcartest.bean.fragments.PropertyFragment;
import shopcartest.bean.fragments.TraditionFragment;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int loadLayoutId() {
        return R.layout.act_mianactivity_act;
    }
